...
class SamFinetuneRunner:
    ...
    def _predict_score_map_tiled(self, predictor, rgb_image, *, tile_size: int, tile_overlap: int, tile_batch_size: int):
        from .tiled_inference import predictor_tile_mask_score, tiled_score_map
    ...
    def predict(self, image_path: str, params: SamFinetuneParams, *, stop_checker=None, log_fn=None) -> dict:
        ...
        from ..runtime.runtime import ensure_dir, filter_small_components, overlay_mask, safe_basename
        from .runtime import (
            resolve_image_size,
        ...
        from .tiled_inference import coarse_refine_model_score_map
    ...
    def segment_boxes(
        ...
        *,
        ...
        from ..runtime.engine import _segment_boxes_with_predictor, SamParams
