...
const defaultClusterDbPath = () => path.join(labRoot, 'infer_results', 'semi-labeling', 'step5_clustering', 'clusters.sqlite3');
...
const defaultSessionsDir = () => path.join(labRoot, 'infer_results', 'semi-labeling', 'step5_clustering', 'sessions');
