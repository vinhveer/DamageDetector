...
def build_sam_vit_h(image_size=1024, num_classes=1, pixel_mean=[123.675, 116.28, 103.53], pixel_std=[58.395, 57.12, 57.375],
...
def build_sam_vit_l(image_size=1024, num_classes=1, pixel_mean=[123.675, 116.28, 103.53], pixel_std=[58.395, 57.12, 57.375],
                    checkpoint=None, decoder_type: str = "baseline", centerline_head: bool = False):
    return _build_sam(
...
def build_sam_vit_b(image_size=1024, num_classes=1, pixel_mean=[123.675, 116.28, 103.53], pixel_std=[58.395, 57.12, 57.375],
                    checkpoint=None, decoder_type: str = "baseline", centerline_head: bool = False):
    return _build_sam(
