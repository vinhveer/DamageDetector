...
def _worker_main(args: argparse.Namespace) -> None:
    ...
    if finetune_checkpoint:
        ...
        overrides.append(f"train.finetune_checkpoint.require_loaded={bool(args.require_finetune_load)}")
        overrides.append(f"train.finetune_checkpoint.min_loaded_tensors={int(args.min_finetune_tensors)}")
