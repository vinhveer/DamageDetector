...
const defaultSubclusterDbPath = () => path.join(labRoot, 'infer_results', 'semi-labeling', 'step7_label_review', 'subclusters.sqlite3');
const defaultSuspectClusterDbPath = () => path.join(labRoot, 'infer_results', 'semi-labeling', 'step7_label_review', 'suspect_clusters.sqlite3');
...
const defaultSessionsDir = () => path.join(labRoot, 'infer_results', 'semi-labeling', 'step7_label_review', 'sessions');
const cvOofDir = () => path.join(labRoot, 'infer_results', 'semi-labeling', 'step7_label_review');
