...
from data_split.DataSAIL.datasail.reader.read_genomes import read_folder
from data_split.DataSAIL.datasail.reader.read_molecules import remove_duplicate_values
from data_split.DataSAIL.datasail.reader.utils import DataSet, read_data, DATA_INPUT, MATRIX_INPUT, read_data_input
from data_split.DataSAIL.datasail.settings import O_TYPE, UNK_LOCATION, FORM_OTHER
