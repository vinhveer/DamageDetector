...
const defaultStep6Dir = () => path.join(labRoot, 'infer_results', 'semi-labeling', 'step6_classifier');
const defaultStep7Dir = () => path.join(labRoot, 'infer_results', 'semi-labeling', 'step7_label_review');
