# chạy để làm hình cột có vết nứt. Chỉ cần chạy ở chế độ T là được.
...
model_type = "vit_b"
image_path = r"D:\Reseach\19_NCS\SAM GroundDINO\pics\columnCrack.JPG"
...
TEXT_QUERIES = [
    "crack", "mold", "stain", "spall", "damage", "column"
]
