...
from ..runtime.runtime import infer_sam_model_type_from_state_dict, load_checkpoint_state_dict
...
def apply_delta_to_sam(
    *,
    ...
    if normalized == "adapter":
        ...
        if ckpt_middle_dim is not None and int(middle_dim) != ckpt_middle_dim:
            middle_dim = ckpt_middle_dim
        wrapper_module = import_module("segmentation.sam.finetune.delta.sam_adapter_lora_image_encoder")
