...
class ImageLoader:
    def __init__(self) -> None:
        ...
        self._crop_cache: dict[tuple[int, int, float, int], QPixmap] = {}
    ...
    def crop_pixmap(self, row: AssignmentRow, image_root: Path | None, *, padding_ratio: float, image_size: int) -> QPixmap:
        ...
        scaled = crop.scaledToWidth(max(80, int(image_size)))
        self._crop_cache[cache_key] = scaled
        return scaled
