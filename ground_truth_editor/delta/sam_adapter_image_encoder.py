...
class Adapter_Sam(nn.Module):
    def __init__(self, sam_model: Sam, middle_dim: int, scaling_factor: int):
        ...
        for t_layer_i, blk in enumerate(sam_model.image_encoder.blocks):
            ...
            blk.mlp = _Adapter_MLP(scaling_factor, mlp, w_down_linear_mlp, w_up_linear_mlp)

        self.sam = sam_model

    def save_delta_parameters(self, filename: str) -> None:
        """Save adapter + prompt encoder + mask decoder parameters."""
    ...
    def load_delta_parameters(self, filename: str) -> None:
        """Load adapter + prompt encoder + mask decoder parameters."""
